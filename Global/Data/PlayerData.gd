...
#		"8": ["furnace", 10, null],
	...
	"inventory": {
		"0": ["bronze ingot", 999, null],
		"1": ["bronze ingot", 999, null],
		"2": ["bronze ingot", 999, null],
		"3": ["bronze ingot", 999, null],
		"4": ["bronze ingot", 999, null],
		"5": ["bronze ingot", 999, null],
		"6": ["bronze ingot", 999, null],
		"7": ["bronze ingot", 999, null],
		"8": ["bronze ingot", 999, null],
		"9": ["bronze ingot", 999, null],
		"10": ["iron ingot", 999, null],
		"11": ["iron ingot", 999, null],
		"12": ["iron ingot", 999, null],
		"13": ["iron ingot", 999, null],
		"14": ["iron ingot", 999, null],
		"15": ["iron ingot", 999, null],
		"16": ["iron ingot", 999, null],
		"17": ["iron ingot", 999, null],
		"18": ["iron ingot", 999, null],
		"19": ["gold ingot", 999, null],
#			"18": ["wood", 999, null],
#			"19": ["stone", 999, null],
