...
var starting_player_data = {
	...
	"energy": 100,
	"hotbar": {
		"8": ["iron ingot", 999, null],
		"7": ["iron ingot", 999, null],
		"6": ["iron ingot", 999, null],
		"5": ["bronze ingot", 999, null],
		"4": ["iron ingot", 999, null],
		"3": ["iron ingot", 999, null],
		"2": ["iron ingot", 999, null],
		"1": ["iron ingot", 999, null],
		"0": ["iron ingot", 999, null],
#		"0": ["stone sword", 1, 100],
#		"1": ["gold axe", 1, 100],
#		"4": ["bow", 1, 50],
#		"2": ["arrow", 999, null],
...
#		"5": ["fire staff", 1, null],
#		"7": ["raw egg", 999, null],
#		"8": ["poison potion II", 100, null],
#		"9": ["speed potion II", 100, null],
#		"1": ["destruction potion II", 100, null],
...
#		"8": ["furnace", 10, null],
	...
	"inventory": {
			...
			"16": ["wood", 500, null],
			"15": ["stone", 999, null],
#			"13": ["potato seeds", 500, null],
#			"12": ["wheat seeds", 999, null],

			"11": ["iron ingot", 999, null],
			"10": ["bronze ingot", 999, null],
			"9": ["iron ingot", 999, null],
			"8": ["iron ingot", 999, null],
			"7": ["iron ingot", 500, null],
			"6": ["iron ingot", 999, null],
			"5": ["bronze ingot", 999, null],
			"4": ["iron ingot", 999, null],
			"3": ["iron ingot", 999, null],
			...
			"1": ["iron ingot", 999, null],
			"0": ["iron ingot", 999, null],
#			"6": ["wheat flour", 999, null],
#			"5": ["raw filet", 999, null],
#			"4": ["silk", 999, null],
#			"1": ["health potion II", 100, null],
#			"2": ["regeneration potion II", 100, null],
	},
	"combat_hotbar": {
#		"1": ["bread", 20, null],
	},
