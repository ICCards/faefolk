...
func _on_TrashButton_pressed():
	if find_parent("UserInterface").holding_item:
		sound_effects.stream = preload("res://Assets/Sound/Sound effects/UI/trash/trashcan.mp3")
...
func open_trash_can():
	sound_effects.stream = preload("res://Assets/Sound/Sound effects/UI/trash/trashcanlid.mp3")
	sound_effects.volume_db = Sounds.return_adjusted_sound_db("sound", 0)
	sound_effects.play()
