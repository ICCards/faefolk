...
func returnAdjustedAnimTop(_anim):
	...
	if _anim == "draw_left_down" or _anim == "draw_left_up" or _anim == "draw_left_left" or _anim == "draw_left_right":
		return "draw_left"
	if _anim == "throw_up_down" or _anim == "throw_up_up" or _anim == "throw_up_left" or _anim == "throw_up_right":
		return "throw_up"
	if _anim == "throw_down_down" or _anim == "throw_down_up" or _anim == "throw_down_left" or _anim == "throw_down_right":
		return "throw_down"
	if _anim == "throw_right_down" or _anim == "throw_right_up" or _anim == "throw_right_left" or _anim == "throw_right_right":
		return "throw_right"
	if _anim == "throw_left_down" or _anim == "throw_left_up" or _anim == "throw_left_left" or _anim == "throw_left_right":
		return "throw_left"
	return _anim

func returnAdjustedAnimBottom(_anim):
	if _anim == "draw_down" or _anim == "throw_down":
		return "magic_cast_down"
	if _anim == "draw_up" or _anim == "throw_up":
		return "magic_cast_up"
	if _anim == "draw_right" or _anim == "throw_right":
		return "magic_cast_right"
	if _anim == "draw_left" or _anim == "throw_left":
		return "magic_cast_left"
	if _anim == "draw_up_down" or _anim == "throw_up_down":
		return "magic_cast_up_down"
	if _anim == "draw_up_up" or _anim == "throw_up_up":
		return "magic_cast_up_up"
	if _anim == "draw_up_right" or _anim == "throw_up_right":
		return "magic_cast_up_right"
	if _anim == "draw_up_left" or _anim == "throw_up_left":
		return "magic_cast_up_left"
	if _anim == "draw_down_down" or _anim == "throw_down_down":
		return "magic_cast_down_down"
	if _anim == "draw_down_up" or _anim == "throw_down_up":
		return "magic_cast_down_up"
	if _anim == "draw_down_right" or _anim == "throw_down_right":
		return "magic_cast_down_right"
	if _anim == "draw_down_left" or _anim == "throw_down_left":
		return "magic_cast_down_left"
	if _anim == "draw_right_down" or _anim == "throw_right_down":
		return "magic_cast_right_down"
	if _anim == "draw_right_up" or _anim == "throw_right_up":
		return "magic_cast_right_up"
	if _anim == "draw_right_right" or _anim == "throw_right_right":
		return "magic_cast_right_right"
	if _anim == "draw_right_left" or _anim == "throw_right_left":
		return "magic_cast_right_left"
	if _anim == "draw_left_down" or _anim == "throw_left_down":
		return "magic_cast_left_down"
	if _anim == "draw_left_up" or _anim == "throw_left_up":
		return "magic_cast_left_up"
	if _anim == "draw_left_right" or _anim == "throw_left_right":
		return "magic_cast_left_right"
	if _anim == "draw_left_left" or _anim == "throw_left_left":
